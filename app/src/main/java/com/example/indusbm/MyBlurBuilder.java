...
public class MyBlurBuilder {
    public static Bitmap applyBlur(Context pContext, Bitmap pSrcBitmap, float pBlurRadius)
    {
        if (pSrcBitmap != null)
        {
            ...
            ScriptIntrinsicBlur scriptIntrinsicBlur = ScriptIntrinsicBlur.create(renderScript, U8_4(renderScript));
    ...
    public static void createBlurImage(Context context, Bitmap image,ImageView imageView, Float radius) {

        //Create bitmap (Note: Use Image Loading Library like Glide)


        //Blurring
        Bitmap blurredBitmap = MyBlurBuilder.applyBlur(context, image, 0.1F);
        blurredBitmap = MyBlurBuilder.fastblur(blurredBitmap, 100);

        if (blurredBitmap != null)
        {
            //Set Blurred bitmap to imageView
            imageView.setImageBitmap(blurredBitmap);
            //BitmapDrawable ob = new BitmapDrawable(context.getResources(), blurredBitmap);
